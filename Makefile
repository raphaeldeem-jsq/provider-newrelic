...
PROJECT_NAME ?= provider-provider-newrelic
PROJECT_REPO ?= github.com/JuniperSquare/$(PROJECT_NAME)

export TERRAFORM_VERSION ?= 1.3.3

export TERRAFORM_PROVIDER_SOURCE ?= hashicorp/newrelic
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-newrelic.25.0_x5
...
xpkg.build.provider-provider-newrelic: do.build.images
